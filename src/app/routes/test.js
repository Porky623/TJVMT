...
router.get('/update/weighted_score/add', officerCheck, testController.update_weighted_scores);

router.post('/update/weighted_score/add', officerCheck, testController.update_weighted_scores_post);
